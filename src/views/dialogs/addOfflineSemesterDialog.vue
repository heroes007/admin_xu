                    ...
                    <div class="form-item-semester">
                        ...
                        <FormItem class="item-semester item-semester2" label="开课日期" prop="stage1">
                            <DatePicker v-model="form1.stage1" type="daterange" format="yyyy/MM/dd"
                                        placeholder="请选择时间范围" :transfer="true"></DatePicker>
                        </FormItem>
                    ...
                    <div class="form-item-course" v-for="(t,i) in form1.offlineCurriculums" :key="i">
                        <div class="item-course">
                            <span class="item-course-left"><span
                                    class="item-course-title">课程{{$config.addZero(i+1)}}</span>{{t.title}}</span>
                            <span class="item-course-rigth">{{t.type_name}} | {{t.teacher_name}}</span>
                        </div>
                        <FormItem label="上课时间" :prop="'class_start_time'+i" required class="up-date-picker">
                            <DatePicker class="class-time" v-model="form1['class_start_time'+i]" type="datetime"
                                        format="yyyy-MM-dd HH:mm" placeholder="请选择上课时间" ></DatePicker>
                        </FormItem>
