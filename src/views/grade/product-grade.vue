            ...
            <Col>
                <div style="background-color: #fff;width: 100%;height: 100%;">
                    <div class="total-course">
                        ...
                        <tables :is-serial=true :column="columns3" :table-data="list3" ></tables>
                    </div>
                </div>
            </Col>
        </Row>
    ...
    export default {
        ...
        data() {
            return{
                ...
                columns3: [
                    {title: '姓名', key: 'realname', align: 'left'},
                    {title: '账号', key: 'realname', align: 'left'},
                    {title: '学习进度', key: 'realname'},
                    {title: '已评课程', key: 'realname'},
                    {title: '线上课', key: 'realname'},
                    {title: '线下课', key: 'realname'},
                    {title: '是否有帮助', key: 'realname'},
                    {title: '课件质量', key: 'realname'},
                    {title: '满意度', key: 'realname'},
                    {
                        title: '操作',
                        minWidth: 260,
                        slot: 'operation',
