<template>
    <div class='manage-task'>
        <header-component :type='3' :showAdd='true' @addTaskCategory='addTaskCategory'
                          @reRenderList="reRenderListHandler" @manageEdit="manageEdit"/>
        <div class="category-list">
            <category-item v-for='item in categoryList' :key="item.id" :showClose="showClose" :name='item.name'
                           :cid='item.id' :type='item.type'
